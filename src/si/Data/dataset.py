...
# Fill missing values with a specified choice
choice = 'value'
filled_df = df.fillna(choice)

print("\nFilled DataFrame:")
print(filled_df)

# Convert the filled DataFrame back to arrays
X_filled = filled_df[features].values
y_filled = filled_df[label].values
