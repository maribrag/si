...
if __name__ == '__main__':
    ...
    from src.si.Neural_networks.losses import MeanSquaredError
    from src.si.metrics.mse import mse
    from src.si.metrics.accuracy import accuracy
    from src.si.io.csv_file import read_csv

    # training data
    dataset = read_csv('C:\\Users\\maria\\Documents\\GitHub\\si\\datasets\\iris\\iris.csv', sep=',', features=True, label=True)
